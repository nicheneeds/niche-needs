        ...
        <section className="w-full py-24 px-6 md:px-12 lg:px-20 text-center">
            <div className="max-w-[800px] mx-auto space-y-12 flex flex-col items-center">
                ...
                <a
                    ...
                    className="bg-[#2e2e2e] hover:bg-[#2e2e2e] text-white font-['Plus_Jakarta_Sans',sans-serif] font-medium py-4 px-10 rounded-full  hover:opacity-90 active:opacity-80 shadow-lg shadow-black-500/20 flex items-center justify-center gap-2 text-lg w-full sm:w-fit cursor-pointer mt-[-20px] select-none outline-none"
                >
                    Get In Touch
                </a>

...
export function Hero() {
  return (
    <section className="w-full bg-[#ece6e8] px-6 py-6 md:py-20 md:px-12 lg:px-20" aria-label="Hero section">
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12 items-center">
        ...
        <div className="flex flex-col gap-6 lg:gap-6">
          <h1 className="font-['Plus_Jakarta_Sans',sans-serif] font-medium text-3xl md:text-4xl lg:text-5xl leading-tight text-[#2c2c2c]">
            The AI product studio building {" "}
          ...
          <p className="font-['Plus_Jakarta_Sans',sans-serif] font-medium text-[#878787] text-base md:text-lg tracking-[0.3px] leading-relaxed">
            Building and shipping everything from local business tools to social game experiences at the speed of AI.
          </p>
